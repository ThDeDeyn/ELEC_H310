...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("448482bf-d4e1-444d-880d-be5f8b91ad84/ed092b9b-d398-4703-be89-cebf998501f6"),
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80"
`include "D:\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80\AMux_v1_80.v"
`else
`define CY_BLK_DIR "D:\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80"
`include "D:\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80\AMux_v1_80.v"
`endif
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("007039bd-ca70-46f1-9235-e1724acdf933/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("007039bd-ca70-46f1-9235-e1724acdf933/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__LED01_net;
	wire [0:0] tmpFB_0__LED01_net;
	wire [0:0] tmpIO_0__LED01_net;
	wire [0:0] tmpINTERRUPT_0__LED01_net;
	electrical [0:0] tmpSIOVREF__LED01_net;
	...
	cy_psoc3_pins_v1_10
		...
		LED01
		 (.oe(tmpOE__LED01_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED01_net[0:0]}),
		  .io({tmpIO_0__LED01_net[0:0]}),
		  .siovref(tmpSIOVREF__LED01_net),
		  .interrupt({tmpINTERRUPT_0__LED01_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED01_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED02_net;
	wire [0:0] tmpFB_0__LED02_net;
	wire [0:0] tmpIO_0__LED02_net;
	wire [0:0] tmpINTERRUPT_0__LED02_net;
	electrical [0:0] tmpSIOVREF__LED02_net;

	cy_psoc3_pins_v1_10
		#(.id("c75b2027-5583-4da5-86f5-b37e1285aeb7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		LED02
		 (.oe(tmpOE__LED02_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED02_net[0:0]}),
		  .io({tmpIO_0__LED02_net[0:0]}),
		  .siovref(tmpSIOVREF__LED02_net),
		  .interrupt({tmpINTERRUPT_0__LED02_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED02_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__TOP_net;
	wire [0:0] tmpFB_0__TOP_net;
	wire [0:0] tmpIO_0__TOP_net;
	wire [0:0] tmpINTERRUPT_0__TOP_net;
	electrical [0:0] tmpSIOVREF__TOP_net;

	cy_psoc3_pins_v1_10
		#(.id("ba0fb9dc-a9c1-48a2-897d-19dd675b6cb5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		TOP
		 (.oe(tmpOE__TOP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TOP_net[0:0]}),
		  .io({tmpIO_0__TOP_net[0:0]}),
		  .siovref(tmpSIOVREF__TOP_net),
		  .interrupt({tmpINTERRUPT_0__TOP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TOP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED03_net;
	wire [0:0] tmpFB_0__LED03_net;
	wire [0:0] tmpIO_0__LED03_net;
	wire [0:0] tmpINTERRUPT_0__LED03_net;
	electrical [0:0] tmpSIOVREF__LED03_net;

	cy_psoc3_pins_v1_10
		#(.id("24517cf3-5c75-4149-a5f7-ca34e6583eee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		LED03
		 (.oe(tmpOE__LED03_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED03_net[0:0]}),
		  .io({tmpIO_0__LED03_net[0:0]}),
		  .siovref(tmpSIOVREF__LED03_net),
		  .interrupt({tmpINTERRUPT_0__LED03_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED03_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED04_net;
	wire [0:0] tmpFB_0__LED04_net;
	wire [0:0] tmpIO_0__LED04_net;
	wire [0:0] tmpINTERRUPT_0__LED04_net;
	electrical [0:0] tmpSIOVREF__LED04_net;

	cy_psoc3_pins_v1_10
		#(.id("94b060f5-e9ff-4c38-b09d-47fb445cc3c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		LED04
		 (.oe(tmpOE__LED04_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED04_net[0:0]}),
		  .io({tmpIO_0__LED04_net[0:0]}),
		  .siovref(tmpSIOVREF__LED04_net),
		  .interrupt({tmpINTERRUPT_0__LED04_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED04_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("74f58037-87c0-4891-ac65-1d1aa9e98c78"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5b963331-4667-49ff-9905-ad382aa20fea"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("92864c6e-a226-4842-a114-2152ef32578f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("90925468-ed09-4566-825e-3eb46e0b57db"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("291f27b2-aeaa-4cc7-821a-244e1d3d8beb"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("111608d4-5233-44df-ae99-a62ef50a5d5d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a9b06a48-1b97-4a16-8551-1e34e413c368"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b08b99f4-545d-49f4-9805-7c29c7774928"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c3909c13-75fa-4260-b14c-dfd682c18327"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Photores_net;
	wire [0:0] tmpFB_0__Photores_net;
	wire [0:0] tmpIO_0__Photores_net;
	wire [0:0] tmpINTERRUPT_0__Photores_net;
	electrical [0:0] tmpSIOVREF__Photores_net;

	cy_psoc3_pins_v1_10
		#(.id("cb32282b-e449-40c5-80ac-24ea8430ca4f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Photores
		 (.oe(tmpOE__Photores_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Photores_net[0:0]}),
		  .analog({Net_7}),
		  .io({tmpIO_0__Photores_net[0:0]}),
		  .siovref(tmpSIOVREF__Photores_net),
		  .interrupt({tmpINTERRUPT_0__Photores_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Photores_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("48f61761-8252-4140-9c5b-b41e1a185e1c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("97f5994f-08aa-4f85-acea-2797ef98f988"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    Timer_v2_80_4 TimerDAC (
        ...
        .tc(Net_44),
        .trigger(1'b1));
    defparam TimerDAC.CaptureCount = 2;
    defparam TimerDAC.CaptureCounterEnabled = 0;
    defparam TimerDAC.DeviceFamily = "PSoC5";
    defparam TimerDAC.InterruptOnCapture = 0;
    defparam TimerDAC.InterruptOnTC = 1;
    defparam TimerDAC.Resolution = 16;
    defparam TimerDAC.SiliconRevision = "0";
