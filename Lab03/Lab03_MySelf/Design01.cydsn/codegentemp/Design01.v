...
module top ;
	...
	cy_clock_v1_0
		#(.id("f5c44172-c914-4ef9-a6b3-5e8fef4a6e0c"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(10),
		  .period("0"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b6788435-8ace-41e0-8935-4c9922e07a0c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
